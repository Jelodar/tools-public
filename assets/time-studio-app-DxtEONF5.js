import{c as ce,T as le}from"./index-CsqYO7gG.js";import{s as K}from"./ui-utils-CG6aKAAj.js";import{r as X,b as de,s as ue,a as me,g as pe,d as ee,p as ve,f as he}from"./studio-CKR8zP_U.js";import{c as ye}from"./studio-shell-DFrEv7MT.js";function b(a){return String(a??"").replace(/[&<>"']/g,n=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[n])}function ne(a,n,s=""){const r=String(s||"").trim().toLowerCase(),l=a.filter(i=>!r||i.toLowerCase().includes(r));return(l.some(i=>i===n)?l:[n,...l].filter(Boolean)).map(i=>`<option value="${b(i)}"${i===n?" selected":""}>${b(i)}</option>`).join("")}function A({id:a,label:n,options:s,selected:r,placeholder:l="Filter options"}){return`
