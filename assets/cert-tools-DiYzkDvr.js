import{_ as n}from"./index-C4lglzE7.js";import{d,s as o}from"./ui-utils-CG6aKAAj.js";let e=null;function u(i){return String(i??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}async function S(i){e=document.createElement("div"),e.className="tool-certs",e.innerHTML=`
    <div class="card">
