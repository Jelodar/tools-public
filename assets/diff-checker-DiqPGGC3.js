import{g as f,c as v}from"./ui-monaco-CPoxUL_X.js";import"./index-CsqYO7gG.js";let e=null,t=null,g=null;function m(o){return String(o??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}async function S(o){e=document.createElement("div"),e.className="tool-diff-checker",e.innerHTML=`
    <div class="card">
